...
import burp.Menu;
import burp.ScanFun.AxisScan;
import burp.ScanFun.FastJsonScan;
import burp.ScanFun.LaravelScan;
import burp.ScanFun.Log4jScan;
import burp.ScanFun.NacosScan;
import burp.ScanFun.SQLIScan;
import burp.ScanFun.ShiroScan;
import burp.ScanFun.SpringBootActuatorScan;
import burp.ScanFun.SpringCloudScan;
import burp.ScanFun.Text4shellScan;
import burp.ScanFun.ThinkphpScan;
import burp.ScanFun.UeditorScan;
import burp.ScanFun.WeblogicScan;
...
IMessageEditorController {
    ...
    public void registerExtenderCallbacks(IBurpExtenderCallbacks callbacks) {
        ...
        stdout.println("=========================================\n[+]   TsojanScan Plugin Load Successful!\n[+]   Author: Map1e7an\n[+]   Collaborator: Yyy\n[+]   Team: Tsojan Security Team(T.S.T.).\n[+]   Version: 1.4.6\n[+]   Github: https://github.com/Tsojan/TsojanScan\n=========================================");
        SwingUtilities.invokeLater(new Runnable(){
            ...
            public void run() {
                ...
                1 v1 = this;
                configPane = BurpExtender.getFuzzSettingPanel();
                1 v2 = this;
                customPane = BurpExtender.customPanel();
                1 v3 = this;
    ...
    public void doJPathScan(IHttpRequestResponse baseRequestResponse) {
