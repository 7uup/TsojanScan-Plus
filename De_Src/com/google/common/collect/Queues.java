...
public final class Queues {
    ...
    @GwtIncompatible
    public static <E> int drain(BlockingQueue<E> q, Collection<? super E> buffer, int numElements, Duration timeout2) throws InterruptedException {
        return Queues.drain(q, buffer, numElements, timeout2.toNanos(), TimeUnit.NANOSECONDS);
    }
    ...
    @CanIgnoreReturnValue
    @GwtIncompatible
    public static <E> int drainUninterruptibly(BlockingQueue<E> q, Collection<? super E> buffer, int numElements, Duration timeout2) {
        return Queues.drainUninterruptibly(q, buffer, numElements, timeout2.toNanos(), TimeUnit.NANOSECONDS);
    }
