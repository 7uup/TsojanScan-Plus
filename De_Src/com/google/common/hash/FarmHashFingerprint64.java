...
extends AbstractNonStreamingHashFunction {
    ...
    private static long hashLength33To64(byte[] bytes, int offset, int length) {
        ...
        long g2 = (y + LittleEndianByteArray.load64(bytes, offset + length - 32)) * mul;
        long h2 = (z + LittleEndianByteArray.load64(bytes, offset + length - 24)) * mul;
        return FarmHashFingerprint64.hashLength16(Long.rotateRight(e + f, 43) + Long.rotateRight(g2, 30) + h2, e + Long.rotateRight(f + a, 18) + g2, mul);
    }
