...
public final class MediaType {
    ...
    public MediaType withParameters(String attribute, Iterable<String> values2) {
        ...
        if (!this.parameters.isEmpty()) {
            ...
            ListMultimap<String, String> quotedParameters = Multimaps.transformValues(this.parameters, new Function<String, String>(){
                ...
                public String apply(String value) {
                    return TOKEN_MATCHER.matchesAllOf(value) && !value.isEmpty() ? value : MediaType.escapeAndQuote(value);
                }
            });
