...
public final class Chars {
    ...
    @Beta
    public static char constrainToRange(char value, char min2, char max) {
        Preconditions.checkArgument(min2 <= max, "min (%s) must be less than or equal to max (%s)", min2, max);
