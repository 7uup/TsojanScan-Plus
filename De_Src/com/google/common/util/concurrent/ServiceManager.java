...
implements ServiceManagerBridge {
    ...
    public void awaitHealthy(Duration timeout2) throws TimeoutException {
        this.awaitHealthy(Internal.toNanosSaturated(timeout2), TimeUnit.NANOSECONDS);
    }
    ...
    public void awaitStopped(Duration timeout2) throws TimeoutException {
        this.awaitStopped(Internal.toNanosSaturated(timeout2), TimeUnit.NANOSECONDS);
    }
