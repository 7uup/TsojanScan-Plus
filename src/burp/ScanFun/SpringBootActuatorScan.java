...
public class SpringBootActuatorScan {
    ...
    public static IHttpRequestResponse ScanEnv(IHttpRequestResponse baseRequestResponse, IBurpExtenderCallbacks callbacks, IExtensionHelpers helpers) throws FileNotFoundException {
        stdout = new PrintWriter("aaaaa");
